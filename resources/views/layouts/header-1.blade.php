<header class="fixed top-0 w-full z-50">
    <div class="py-1 flex justify-end bg-transparent scroll-hidden md:px-6">
        <div class="relative lg:mt-0 lg:mx-4">
            <input type="text" class="w-48 py-2 pl-4 pr-10 text-gray-100 placeholder-gray-100 bg-transparent border-b border-gray-100 lg:w-56 lg:border-transparent focus:outline-none focus:border-gray-100" placeholder="Search">
        ...
        <div class="flex items-center md:order-2 space-x-1 md:space-x-0">
            <button type="button" data-dropdown-toggle="language-dropdown-menu" class="inline-flex items-center justify-center px-4 py-2 text-sm text-white rounded-lg cursor-pointer hover:bg-blue-900">
    ...
    <nav x-data="{ isOpen: false }" class="bg-transparent nav-scroll relative">
            ...
            <div class="flex items-center justify-between">
                ...
                <div x-cloak :class="[isOpen ? '-translate-x-0 opacity-100 ' : 'opacity-0 translate-x-full']" class="absolute top-0 h-screen md:h-auto inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white/90 shadow-md lg:bg-transparent lg:dark:bg-transparent lg:shadow-none lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:w-auto lg:opacity-100 lg:translate-x-0 batas">
                    <div class="flex flex-col md:flex-row justify-center h-auto gap-4 md:gap-0 py-16 md:py-0 relative">
                        ...
                        <div class="px-8">
                            <a href="/" class="{{($title == "Beranda")? "font-bold text-blue-900" : "font-medium text-white hover:text-[#10169f]"}}">Home</a>
                        </div>
                        <div class="px-8">
                            <a href="/about" class="{{($title == "About")? "font-bold text-blue-900" : "font-medium text-white hover:text-[#10169f]"}}">About</a>
                        </div>
                        <div class="group px-8">
                            <a href="/programs-publications" class="relative {{($title == "Programs & Publications")? "font-bold text-blue-900" : "font-medium text-white hover:text-[#10169f]"}}">
                        ...
                        <div class="px-8">
                            <a href="/news" class="{{($title == "News")? "font-bold text-blue-900" : "font-medium text-white hover:text-[#10169f]"}}">News</a>
                        </div>
                        <div class="px-8">
                            <a href="/events" class="{{($title == "Events")? "font-bold text-blue-900" : "font-medium text-white hover:text-[#10169f]"}}">Events</a>
                        </div>
                        <div class="px-8">
                            <a href="/contact" class="{{($title == "Contact")? "font-bold text-blue-900" : "font-medium text-white hover:text-[#10169f]"}}">Contact</a>
                        </div>
                        <div class="px-8">
                            <a href="/careers" class="{{($title == "Careers")? "font-bold text-blue-900" : "font-medium text-white hover:text-[#10169f]"}}">Careers</a>
                        </div>
                        <div class="px-8">
                ...
                <div class="flex">
                    <a href="" class="px-8 py-2 md:px-8 md:py-1.5 border-2 border-blue-900 bg-blue-900 rounded-lg mr-2 hidden md:block font-medium text-white relative overflow-hidden hover:bg-blue-950">
