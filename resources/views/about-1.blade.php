...
<section class="text-gray-600 body-font relative">
    <div class="flex overflow-hidden" style="height: max-content">
        <h1 class="absolute lg:-top-[1.5%] top-8 lg:left-[58.3%] left-[50%] transform -translate-x-1/2 lg:text-9xl text-2xl font-extrabold w-full md:w-auto text-white md:text-gray-700 text-center bg-blue-500 md:bg-transparent md:text-left">
            <span class="absolute font-extrabold text-[14rem] -right-32 top-6 text-right text-gray-200 z-10 pointer-events-none hidden md:block">DO</span>
...
<section class="bg-blue-500 relative">
    <div class="container px-5 mx-auto flex flex-wrap">
        <div class="flex relative pt-28 pb-28 sm:items-center md:w-2/3 mx-auto">
            ...
            <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    <h1 class="text-4xl text-gray-200 font-medium mb-4 text-center">Mari Bersama Membangun Negeri-></h1>
                    <button class="border-2 border-gray-200 px-12 py-2 rounded-lg font-medium text-gray-100 cursor-pointer">Learn more</button>
                </div>
            </div>
        </div>
    </div>
