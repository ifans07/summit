...
{{-- about hero --}}
<section class="w-full z-20 relative overflow-hidden bg-blue-500">
    ...
    <div class="absolute z-10 left-[50%] -top-[0%] bg-blue-500/70">
        <img src="/assets/about/about3.jpg" class="max-h-full max-w-full" alt="">
        <div class="absolute inset-0 bg-gradient-to-r from-blue-500 via-transparent to-blue-500 pointer-events-none"></div>
        
        <div class="absolute inset-0 bg-gradient-to-b from-transparent to-gray-300 pointer-events-none"></div>
        
    </div>

    <div class="container h-[38rem] w-full flex items-center px-20 relative mx-auto z-20">
...
<section class="bg-gray-300 relative overflow-hidden">
    <div class="mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:px-8">
        <h2 class="text-4xl md:text-8xl font-bold text-gray-900 text-center mb-12">
            <div class="hidden md:block absolute uppercase text-gray-400 -left-[29%] -top-[6%] text-center text-[14rem]">history</div>
            <div class="hidden md:block absolute uppercase text-gray-400 -right-[33%] -top-[6%] text-center text-[14rem]">history</div>
...
<section class="text-gray-600 body-font relative">
    ...
    <div class="flex items-center justify-center">
        <h1 class="absolute top-8 left-[50%] transform -translate-x-1/2 text-2xl font-extrabold md:hidden w-full text-center text-white bg-blue-500">What Are Our Values?</h1>
        ...
        <div class="container mx-auto text-right w-full mr-8 hidden md:block relative">
            ...
            <h1 class="text-9xl font-extrabold z-30 relative">What Are Our Values?</h1>
        </div>
    </div>
</section>
...
<section class="text-gray-600 body-font relative">
    <div class="flex overflow-hidden" style="height: max-content">
        <h1 class="absolute lg:-top-[1.5%] top-8 lg:left-[58.3%] left-[50%] transform -translate-x-1/2 lg:text-9xl text-2xl font-extrabold w-full md:w-auto text-white md:text-gray-700 text-center bg-blue-500 md:bg-transparent md:text-left">
            <span class="absolute font-extrabold text-[14rem] -right-32 top-6 text-right text-gray-300 z-10 pointer-events-none hidden md:block">DO</span>
            <span class="z-20 relative">What Do We Do?</span>
        </h1>
