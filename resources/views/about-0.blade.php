    ...
    <div class="container mx-auto px-8 py-20 flex flex-col">
        <div class="flex flex-col md:flex-row md:items-center gap-8 mb-8 md:px-20">
            <div class="md:w-1/5 h-auto rounded-lg bg-blue-900 p-4 text-white">
                <h1 class="text-4xl font-extrabold font-merriweather mb-4 uppercase">About Us</h1>
                <ul class="text-left">
                    <li class="mb-4">
                        <a href="#" class="hover:underline transition duration-300 ease-in-out">Our Story</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline transition duration-300 ease-in-out">Our Values</a>
                    </li>
                    <li class="mb-4">
            ...
            <div class="md:w-4/5 h-auto md:pl-8 md:border-l-2 py-8 md:px-4 border-blue-900">
                <h1 class="font-merriweather text-4xl font-extrabold mb-8">Yayasan Institut Pengembangan Suara Mitra or also known as the SUMMIT Institute of Development (SID)</h1>
                <p class="text-xl">"With every newborn baby, a little sun rises." - IRMGARD ERATH</p>
            </div>
        </div>
        <div class="overflow-hidden h-[30rem] rounded-lg">
            <img src="{{asset('assets/about/about3.jpg')}}" class="rounded-lg object-cover w-full h-full filter grayscale -translate-y-[20%]" alt="">
        </div>
    </div>
</section>
...
<section>
    <div class="container mx-auto px-8 py-28">
        <div>
            <div class="mb-8">
                <h1 class="text-4xl font-extrabold uppercase font-merriweather mb-8">Leadership</h1>
                <p class="text-lg text-gray-700 w-3/4 mb-8">Our Board of Directors, Executive Board, and Supervisory and Monitoring Board come from various backgrounds including medicine, health research, education, and management. Members of the Senior Management Team also come from a wide range of backgrounds, including medicine, public health, veterinary science, education, management, and business administration.</p>
                <a href="/about/leadership" class="underline underline-offset-4 text-lg">Search leadership</a>
            </div>
            <div class="flex flex-wrap">
                <div class="p-4 lg:w-1/2 md:w-1/2 border border-blue-900">
                    <div class="h-full flex flex-col border border-red-500">
                    <img alt="team" class="flex-shrink-0 rounded-lg w-2/3 h-auto object-cover mb-4 border border-blue-900" src="/assets/leadership/yuni.avif">
                        <div class="w-2/3">
                            <h2 class="title-font font-extrabold font-merriweather text-2xl text-gray-900">Yuni Dwi Setiyawati, MHID., Dietisien</h2>
                            <h3 class="text-gray-500 mb-3">Chair of The Executive Board</h3>
                ...
                <div class="p-4 lg:w-1/2 md:w-1/2 border border-blue-900">
                    <div class="h-full flex flex-col border border-red-500">
                    <img alt="team" class="flex-shrink-0 rounded-lg w-2/3 h-auto object-cover mb-4 border border-blue-900" src="/assets/leadership/tinus.avif">
                    <div class="w-2/3">
                        <h2 class="title-font font-extrabold font-merriweather text-2xl text-gray-900">Martinus Pradipto</h2>
                        <h3 class="text-gray-500 mb-3">Foundation Secretary</h3>
